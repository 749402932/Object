...
/**
 * Created by mayuedong on 2016/2/23.
 */
        ...
        import com.keren.bean.TableName;
        import com.keren.utils.TranDate;

public class HuoChe extends Activity implements OnClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        upani = AnimationUtils.loadAnimation(HuoChe.this, R.anim.top2_in);
        downani = AnimationUtils.loadAnimation(HuoChe.this, R.anim.top1_in);
    ...
    public void onClick(View v)
    {
        ...
        if(v.getId()==R.id.ticket_back)
        {
            ...
            intent1.setClass(HuoChe.this, MainActivity.class);
            startActivity(intent1);
            HuoChe.this.finish();
        }

        if(v.getId()==R.id.tiket_find)//查询button
        {
            ...
            dialog.show();
            findTiket(date, city[0], city[1]);//调用查询方法
        }
...
//验证远程安全套接字
                    ...
                    if (code == 200)
                    {
                        ...
                        if(result!=null)
                        {
                            ...
                            {
                                handler.sendEmptyMessage(1);//启动线程向主线程发送数据，进行UI更新
                            }
                            else
                            {
    ...
    {//简单适配器，将集合数据适配到listview列表
        simpleAdapter = new SimpleAdapter(HuoChe.this, list, R.layout.tiket_listview, new String[]{"车次","起始站","终点站","出发时间","到达时间","历时","商务座","特等座","一等座","二等座","高级软卧","无座","软卧","硬卧","硬座","软座","日期","备注","info"},
