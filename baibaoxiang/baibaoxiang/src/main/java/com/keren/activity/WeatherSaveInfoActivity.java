...
public class WeatherSaveInfoActivity extends Activity {
    ...
    private void goHome() {
    	Log.i(TAG, "goHome");
        Intent intent = new Intent(WeatherSaveInfoActivity.this, Weather.class);
        WeatherSaveInfoActivity.this.startActivity(intent);
        WeatherSaveInfoActivity.this.finish();
    }
